...
- NonLinear Regression (Non Linear Model) (parametric model)
    ...
    - Domain Expert Regression : 
        ...
        - Disadvantages : 
            ...
            - Manual process
        - Overfitting : use the same regularization techniques as discussed in polynomial regression.
    ...
    - [Kernel Regression](https://khetansarvesh.medium.com/kernel-regression-fc38027cc3f3)
        - Overfitting : Use same regularization techniques as discussed in polynomial regression
        - Explainability : Weights can be used to explain which feature is important
---
- 
- 
